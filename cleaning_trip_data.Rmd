...
Here I take a look at structure of the data
...
### change string types for month and year
...
trip_variables <- trip_data3 %>%
  select(ride_id,rideable_type, start_station_name, end_station_name, member_casual, ride_length, day_of_week, month)
```
